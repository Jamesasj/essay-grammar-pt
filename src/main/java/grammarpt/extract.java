...
public class extract {
	   public static void main(String[] args) throws SAXException, IOException {
		   ...
		   // Para cada objeto essay é instanciado uma classe cogroo
		   ...
		   /* James : a instancia execiva das classes no cogroo na classe Essay pode estar ocupando
		    * a memória execiva em uma lista. Talvez uma instancia estatica reduza o tempo de chamada
		    * das funcionalidades do cogroo.
		    */ 
